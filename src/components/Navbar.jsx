...
//           />
//           <motion.span
//             className="font-extrabold text-3xl select-none text-primary"
...
//       key={link.href}
//       href={link.href}
//       className="relative group text-gray-700 hover:text-primary transition-colors duration-300"
//       custom={i}
//       initial="hidden"
//       animate="visible"
...
//       {/* underline on hover */}
//       <span
//         className="absolute left-0 -bottom-1 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full rounded"
//       ></span>
//     </motion.a>
//   ))}
...
//   <motion.a
//     href="#contact"
//     className="btn-primary px-6 py-2 rounded-full bg-primary text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300"
...
//           >
//             <motion.div className="flex flex-col px-6 py-4 gap-3">
//               {navLinks.map((link, i) => (
//                 <motion.a
//                   key={link.href}
//                   href={link.href}
